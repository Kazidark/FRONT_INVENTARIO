...
import {
  OverlayService
} from "./chunk-CI7EF4BF.js";
import {
  CSSTransition
} from "./chunk-NGHEAJ4W.js";
import {
  Tooltip
} from "./chunk-HX5Q4GTF.js";
import {
  Portal
} from "./chunk-OED64RDM.js";
import {
  ComponentBase,
  ...
  useUnmountEffect,
  useUpdateEffect
} from "./chunk-QHMVOFFW.js";
import "./chunk-YF4B4G2L.js";
import {
  PrimeReact,
  PrimeReactContext
} from "./chunk-4M2ZJKHV.js";
import {
  DomHandler,
  ObjectUtils,
  ZIndexUtils,
  classNames
} from "./chunk-42LOCNDQ.js";
import {
  require_react
...
var ColorPickerPanel = React.forwardRef(function(props, ref) {
...
var ColorPicker = React.memo(React.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React.useContext(PrimeReactContext);
  var props = ColorPickerBase.getProps(inProps, context);
  var _React$useState = React.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), overlayVisibleState = _React$useState2[0], setOverlayVisibleState = _React$useState2[1];
  ...
  var getPositionY = function getPositionY2(event) {
    if (event.pageY !== void 0) return event.pageY;
    else if (event.changedTouches !== void 0) return event.changedTouches[0].pageY;
    else return 0;
  };
  ...
  var createColorSelector = function createColorSelector2() {
    ...
    return React.createElement("div", selectorProps, React.createElement("div", colorProps, React.createElement("div", colorHandlerProps)));
  };
  var createHue = function createHue2() {
    ...
    return React.createElement("div", _extends({
      ref: hueViewRef
    }, hueProps), React.createElement("div", _extends({
      ref: hueHandleRef
    }, hueHandlerProps)));
  };
  var createContent = function createContent2() {
    ...
    return React.createElement("div", contentProps, colorSelector, hue);
  };
  ...
  return React.createElement(React.Fragment, null, React.createElement("div", rootProps, input2, React.createElement(ColorPickerPanel, {
    ...
    ptm,
    cx
  }, content)), hasTooltip && React.createElement(Tooltip, _extends({
    target: elementRef,
